...
public class TRestoreSessionReq implements org.apache.thrift.TBase<TRestoreSessionReq, TRestoreSessionReq._Fields>, java.io.Serializable, Cloneable, Comparable<TRestoreSessionReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TRestoreSessionReq");
  ...
  static {
    schemes.put(StandardScheme.class, new TRestoreSessionReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TRestoreSessionReqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRestoreSessionReq.class, metaDataMap);
  }

  public TRestoreSessionReq() {
    this.client_protocol = org.apache.hive.service.rpc.thrift.TProtocolVersion.HIVE_CLI_SERVICE_PROTOCOL_V8;
   ...
   */
  public TRestoreSessionReq(TRestoreSessionReq other) {
  ...
  public TRestoreSessionReq deepCopy() {
    return new TRestoreSessionReq(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TRestoreSessionReq)
      return this.equals((TRestoreSessionReq)that);
    return false;
  }

  public boolean equals(TRestoreSessionReq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TRestoreSessionReq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TRestoreSessionReq(");
    boolean first = true;
  ...
  private static class TRestoreSessionReqStandardSchemeFactory implements SchemeFactory {
    public TRestoreSessionReqStandardScheme getScheme() {
      return new TRestoreSessionReqStandardScheme();
    }
  }

  private static class TRestoreSessionReqStandardScheme extends StandardScheme<TRestoreSessionReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TRestoreSessionReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRestoreSessionReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TRestoreSessionReqTupleSchemeFactory implements SchemeFactory {
    public TRestoreSessionReqTupleScheme getScheme() {
      return new TRestoreSessionReqTupleScheme();
    }
  }

  private static class TRestoreSessionReqTupleScheme extends TupleScheme<TRestoreSessionReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TRestoreSessionReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TRestoreSessionReq struct) throws org.apache.thrift.TException {
