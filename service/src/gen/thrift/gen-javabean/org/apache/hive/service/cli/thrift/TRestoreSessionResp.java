...
public class TRestoreSessionResp implements org.apache.thrift.TBase<TRestoreSessionResp, TRestoreSessionResp._Fields>, java.io.Serializable, Cloneable, Comparable<TRestoreSessionResp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TRestoreSessionResp");
  ...
  static {
    schemes.put(StandardScheme.class, new TRestoreSessionRespStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TRestoreSessionRespTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRestoreSessionResp.class, metaDataMap);
  }

  public TRestoreSessionResp() {
   ...
   */
  public TRestoreSessionResp(TRestoreSessionResp other) {
  ...
  public TRestoreSessionResp deepCopy() {
    return new TRestoreSessionResp(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TRestoreSessionResp)
      return this.equals((TRestoreSessionResp)that);
    return false;
  }

  public boolean equals(TRestoreSessionResp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TRestoreSessionResp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TRestoreSessionResp(");
    boolean first = true;
  ...
  private static class TRestoreSessionRespStandardSchemeFactory implements SchemeFactory {
    public TRestoreSessionRespStandardScheme getScheme() {
      return new TRestoreSessionRespStandardScheme();
    }
  }

  private static class TRestoreSessionRespStandardScheme extends StandardScheme<TRestoreSessionResp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TRestoreSessionResp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.configuration = new HashMap<String,String>(2*_map172.size);
                String _key173;
                String _val174;
                for (int _i175 = 0; _i175 < _map172.size; ++_i175)
                {
                  ...
                  struct.configuration.put(_key173, _val174);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRestoreSessionResp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.configuration != null) {
        if (struct.isSetConfiguration()) {
          oprot.writeFieldBegin(CONFIGURATION_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter176 : struct.configuration.entrySet())
            {
  ...
  private static class TRestoreSessionRespTupleSchemeFactory implements SchemeFactory {
    public TRestoreSessionRespTupleScheme getScheme() {
      return new TRestoreSessionRespTupleScheme();
    }
  }

  private static class TRestoreSessionRespTupleScheme extends TupleScheme<TRestoreSessionResp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TRestoreSessionResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetConfiguration()) {
        {
          ...
          for (Map.Entry<String, String> _iter177 : struct.configuration.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TRestoreSessionResp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.configuration = new HashMap<String,String>(2*_map178.size);
          String _key179;
          String _val180;
          for (int _i181 = 0; _i181 < _map178.size; ++_i181)
          {
            ...
            struct.configuration.put(_key179, _val180);
          }
        }
        struct.setConfigurationIsSet(true);
      }
