...
TCLIService_RestoreSession_args::~TCLIService_RestoreSession_args() throw() {
}


uint32_t TCLIService_RestoreSession_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TCLIService_RestoreSession_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TCLIService_RestoreSession_args");
...
TCLIService_RestoreSession_pargs::~TCLIService_RestoreSession_pargs() throw() {
}


uint32_t TCLIService_RestoreSession_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TCLIService_RestoreSession_pargs");
...
TCLIService_RestoreSession_result::~TCLIService_RestoreSession_result() throw() {
}


uint32_t TCLIService_RestoreSession_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TCLIService_RestoreSession_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("TCLIService_RestoreSession_result");
...
TCLIService_RestoreSession_presult::~TCLIService_RestoreSession_presult() throw() {
}


uint32_t TCLIService_RestoreSession_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void TCLIServiceClient::RestoreSession(TRestoreSessionResp& _return, const TRestoreSessionReq& req)
{
  send_RestoreSession(req);
  recv_RestoreSession(_return);
}

void TCLIServiceClient::send_RestoreSession(const TRestoreSessionReq& req)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("RestoreSession", ::apache::thrift::protocol::T_CALL, cseqid);

  TCLIService_RestoreSession_pargs args;
  args.req = &req;
  args.write(oprot_);
...
void TCLIServiceClient::recv_RestoreSession(TRestoreSessionResp& _return)
{
  ...
  if (fname.compare("RestoreSession") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  TCLIService_RestoreSession_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "RestoreSession failed: unknown result");
}
...
void TCLIServiceProcessor::process_RestoreSession(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("TCLIService.RestoreSession", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "TCLIService.RestoreSession");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "TCLIService.RestoreSession");
  }

  TCLIService_RestoreSession_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "TCLIService.RestoreSession", bytes);
  }

  TCLIService_RestoreSession_result result;
  try {
    iface_->RestoreSession(result.success, args.req);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "TCLIService.RestoreSession");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("RestoreSession", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "TCLIService.RestoreSession");
  }

  oprot->writeMessageBegin("RestoreSession", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "TCLIService.RestoreSession", bytes);
  }
}
...
void TCLIServiceConcurrentClient::RestoreSession(TRestoreSessionResp& _return, const TRestoreSessionReq& req)
{
  int32_t seqid = send_RestoreSession(req);
  recv_RestoreSession(_return, seqid);
}

int32_t TCLIServiceConcurrentClient::send_RestoreSession(const TRestoreSessionReq& req)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("RestoreSession", ::apache::thrift::protocol::T_CALL, cseqid);
...
void TCLIServiceConcurrentClient::recv_RestoreSession(TRestoreSessionResp& _return, const int32_t seqid)
{
